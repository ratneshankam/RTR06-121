...
struct MyPoint
{
    int x_ra;
    int y_ra;
} point_ra; // Declaring a single variables of type 'struct MyPoint' globally...
...
} point_properties_ra; // Declaring a single variables of type 'struct MyPointProperties' globally...
