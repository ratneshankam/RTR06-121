...
struct MyPoint point_ra; // Declaring a single variables of type 'struct MyPoint' globally...
struct MyPointProperties point_properties_ra; // Declaring a single variables of type 'struct MyPointProperties' globally...
